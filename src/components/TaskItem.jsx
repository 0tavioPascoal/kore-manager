...
const TaskItem = ({ task, handleClickedCheckbox, handleClickedDelete }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        >
          <input
            ...
            onChange={() => handleClickedCheckbox(task.id)}
          />
      ...
      <div className="flex items-center gap-2">
        <Button variant="ghost" onClick={() => handleClickedDelete(task.id)}>
